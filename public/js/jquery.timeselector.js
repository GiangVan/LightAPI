...
(function($) {
	...
	Timeselector.prototype = {
		...
		_generateHtml: function() {
			return '<div id="timeselector-div" class="timeselector" style="width:143px;height:100px;">' + 
					'<div class="timeselector-item timeselector-hour" data-type="hour">' + 
					'<a class="timeselector-button timeselector-up" style="width:64px;height:35px;">+</a>' + 
					'<span class="timeselector-value"></span>' + 
					'<a class="timeselector-button timeselector-down" style="width:64px;height:35px;">-</a>' + 
					'</div>' + 
